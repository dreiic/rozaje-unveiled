        ...
        <div className="relative flex min-h-[100dvh] w-full flex-col items-center">
          ...
          >
            <img
              ...
              loading="eager"
            />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_75%_28%,rgba(244,210,160,0.28),transparent_34%),linear-gradient(90deg,rgba(4,12,20,0.72),rgba(4,12,20,0.28)_44%,rgba(4,12,20,0.05)_72%),linear-gradient(180deg,rgba(4,10,17,0.32),rgba(4,10,17,0.08)_44%,rgba(4,10,17,0.78))]" />
          </motion.div>
            ...
            <div className="relative flex h-[100dvh] w-full flex-col items-center justify-center">
              ...
              >
                ...
                <div className="relative z-10 mt-4 flex flex-col items-center text-center transition-none">
                  {date && (
                    <p
                      className="font-serif text-2xl text-white/86"
                  ...
                  {scrollToExpand && (
                    <p
                      className="text-center font-medium text-white/76"
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>
              ...
              >
                <motion.h2
                  className="font-display text-[clamp(5rem,15vw,14rem)] font-medium leading-[0.76] text-white transition-none"
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h2>
