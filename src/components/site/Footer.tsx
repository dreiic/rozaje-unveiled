...
const footerCopy = {
  de: {
    ...
    read: "Lesen",
    links: ["Winter in Rožaje", "Sommer & Natur", "Aufenthalt", "Preise & Realität", "Alle Artikel"],
    contact: "Kontakt",
  ...
  en: {
    ...
    read: "Read",
    links: ["Winter in Rožaje", "Summer & Nature", "Where to stay", "Prices & reality", "All articles"],
    contact: "Contact",
    location: "Rožaje, Montenegro",
      ...
      <div className="mx-auto max-w-[1400px] px-6 py-20 md:px-10">
        <div className="grid gap-12 md:grid-cols-12 md:gap-16">
          <div className="md:col-span-6">
            ...
            <div className="font-serif text-2xl leading-tight md:text-3xl">{copy.headline}</div>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-muted-foreground">{copy.location}</li>
              <li>
